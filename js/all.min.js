					 ...
					 var Brav1Toolbox=(
					 	...
					 	function h(m,n){
					 		if(m.classList)
					 			...
					 			return{addListener:k,dispatchEvent:c,testCSS:g,getPrefixed:j,typeOf:e,addClass:h,removeClass:a,hasClass:f,distance:b}
					 		}
					 		)();
					/*!
					 * Flowtime.js
					 															...
					 															function bV(b0,b2,b3){
					 																...
					 																for(var b1=0;b1<bs[b0][b2].length;b1++)
					 																{
					 																	if(b1>=b3)
					 																		...
					 																		Brav1Toolbox.removeClass(bs[b0][b2][b1],aI)}b3-=1;
					 																		if(b3>=0)
					 																			{Brav1Toolbox.addClass(bs[b0][b2][b3],aI)}
					 																		bC[b0][b2]=b3;
					 																	}
					 																	...
					 																	function bR(){return bN}
					 																	function bx(b0){return bm[b0]}
					 																	function bz(){return bw}
					 																	function bY(){return bB}
					 																	function bE(){return bZ}
					 																	function bA(){return bK}
					 																	function bL(b2){
					 																		var b1=bT;
					 																	var b0=bq;
					 																	if(b2!=undefined)
					 																		{b1=b2.parentNode.index;b0=b2.index}
					 																return{section:b1,page:b0}
					 																}
					 																	function bS(b0){return bN[b0]}
					 																	function bu(b0,b1){return bm[b1][b0]}
					 																	function bh(){return bN[bT]}
					 																	function bP(){return bm[bT][bq]}
					 																	function bH(){return bs[bT][bq][e()]}
					 																	function e(){return bC[bT][bq]}
					 																	function by(){return bT<bN.length-1}
					 																	function bf(){return bT>0}
					 																	function bl(){return bq<bm[bT].length-1}
					 																	function bd(){return bq>0}
					 																	function bG(){
					 																		if(bT==0&&bq==0)
					 																		{return 0}
					 																var b1=0;
					...
					();
					 												...
					 												if(Brav1Toolbox.hasClass(ba,aM))
					 														{bd.preventDefault();V(ba,null,true)}
					 											}
					 													...
					 													var a8=z.setPage(a9);
					 														V(a8,false)}Brav1Toolbox.addListener(window,"hashchange",L);
					 														function L(ba,bb){
					 															if(aA||bb)
					 															{
					 													...
					 													a8=(parseInt(a8)/100)*window.innerWidth}
					 														...
					 														e=(parseInt(e)/100)*window.innerHeight;
					 															...
					 															Brav1Toolbox.addListener(window,"scroll",f);
					 																	function f(a8){a8.preventDefault();ad()}
					 																	var aR=(
					 																		function n(){
					 																			var ba=NaN;
					 																		function a9(){
					 																		...
					 																		function aZ(a8){
					 																			...
					 																			if(a9==null)
					 																				{a9=ba.querySelector(aK)}return a9}
					 																		}
					 																				return}
					 																				function aQ(){z.update();L(null,true)}
					 																				function a1(bb){
					 																					var ba=aF;
					 																					var e=z.getCurrentPage().getAttribute("data-title");
					 																					if(e==null){var a9=bb.split("/");
					 																				...
					 																				function d(e){return(e.getAttribute("data-id")!=null?e.getAttribute("data-id").replace(/__/,""):e.getAttribute("data-prog").replace(/__/,""))}
					 																				function aV(e){
					 																					if(e.substr(0,2)!="__")
					 																						{return"__"+e}
					 																					else
					 																								...
					 																								if(Brav1Toolbox.testCSS("transform"))
					 																									{
					 																										...
					 																										{
					 																											if(C)
					 																												{J.style.top=-ba+"px";J.style.left=-a8+"px"}
					 																											else
					 																												{
					 																													J.style.top=-ba*100+"%";
					 																													J.style.left=-a8*100+"%";
					 																																		...
					 																																		for(var bg=0;bg<ba.length;bg++)
					 																																			{
					 																																				...
					 																																				if(bf!=undefined)
					 																																					...
					 																																					function ad(){window.scrollTo(0,0)}
					 																																					var az=null;
					 																																					var aw=null;
					 																																					function aW(){
					 																																						...
					 																																						for(var ba=0;ba<z.getSectionsLength();ba++)
					 																																							...
					 																																							function a5(){
					 																																								if(az!=null)
					 																																									...
					 																																									function ag(){return az}
					 																																									function af(e,a8){
					 																																										if(H)
					 																																											{o(e,a8)}
					 																																										else
					 																																											{O=z.getCurrentPage();U()}
					 																																									}
					 																																									function o(e,a8){
					 																																										H=false;
					 																																															...
					 																																															if(a8!="INPUT"&&a8!="TEXTAREA"&&a8!="SELECT")
					 																																																{
					 																																																	...
					 																																																	switch(ba.keyCode)
					 																																																	{
					 																																																		...
					 																																																		case 36:i();
					 																																																		break;
					 																																																		case 37:b(ba.shiftKey);
					 																																																		break;
					 																																																		case 39:K(ba.shiftKey);
					 																																																		break;
					 																																																		case 38:aH(ba.shiftKey);
					 																																																		break;
					 																																																		case 40:ae(ba.shiftKey);
					 																																																		break;
					 																																																		case 13:if(H)
					 																																																...
					 																																																if(document.location.hash.length>0)
					 																																																	{
					 																																																		...
					 																																																		L(null,true);Brav1Toolbox.removeClass(J,"no-transition");
					 																																																	}
					 																																																	else
					 																																																		{
					 																																																															...
					 																																																															if(bb!=null&&bb!=undefined)
					 																																																																{
					 																																																																	...
					 																																																																	if(Brav1Toolbox.typeOf(a8[0])==="Number"||a8[0]===0)
					 																																																																		{
					 																																																																			var a9=z.getPageByIndex(a8[1],a8[0]);V(a9);
					 																																																																			return;}
					 																																																																		}
					 																																																																	}
					 																																																																	function i(){aB(0,0)}
					 																																																																	function aD(){var e=z.getSectionsLength()-1;aB(e,z.getPages(e).length-1)}
					 																																																																	function c(){var e=z.getPageIndex();aB(e.section,0)}
					 																																																																	function aj(){var e=z.getPageIndex();aB(e.section,z.getPages(e.section).length-1)}
					 																																																																	function am(a9,a8,e){Brav1Toolbox.addListener(document,a9,a8,e)}
					 																																																																	function ap(e){x=e;ai(e)}
					 																																																																	function ai(e){p=e}
					 																																																																	function a0(e){aJ=e}
					 																																																																	function a2(e){C=e;V()}
					 																																																																	function r(e){M=e}
					 																																																																		...
					 																																																																		if(aE)
					 																																																																			{
					 																																																																				...
					 																																																																				function aC(e){ao=e}
					 																																																																				return{start:a,updateNavigation:aQ,nextSection:K,prevSection:b,next:ae,prev:aH,nextFragment:ae,prevFragment:aH,gotoPage:aB,gotoHome:i,gotoTop:c,gotoBottom:aj,gotoEnd:aD,toggleOverview:af,fragmentsOnSide:ap,fragmentsOnBack:ai,useHistory:a0,slideInPx:a2,sectionsSlideToTop:r,gridNavigation:q,useOverviewVariant:X,twoStepsSlide:al,showProgress:aT,addEventListener:am,defaultParallaxValues:at,parallaxInPx:aC,getDefaultProgress:ag}})();
					 																	(
					 																		function(h,o,g){
					 																		var p=function(){
					 																			...
					 																			return!(b.canPlayType&&b.canPlayType("audio/mpeg;").replace(/no/,""))}(),hasFlash:function(){if(navigator.plugins&&navigator.plugins.length&&navigator.plugins["Shockwave Flash"])return true;else if(navigator.mimeTypes&&navigator.mimeTypes.length){var b=
